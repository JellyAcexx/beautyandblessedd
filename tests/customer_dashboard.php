    ...
    <div class="col-auto d-none d-md-flex flex-column p-3 min-vh-100" id="sidebar">
      ...
      <ul class="nav flex-column" role="tablist" id="sidebarNav">
        ...
        <li class="nav-item mb-2 position-relative">
          <a class="nav-link desktop-nav" href="#" onclick="loadPage('notifications.php', this)" data-page="notifications.php">
            <span class="icon-wrap position-relative">
              <i class="fa-solid fa-bell me-2"></i>
              <span id="notifBadgeSidebar" class="badge position-absolute">1</span>
            </span>
            Notifications
          </a>
        </li>
        <li class="nav-item mb-2"><a class="nav-link desktop-nav" href="#" onclick="loadPage('cart.php', this)" data-page="cart.php"><i class="fa-solid fa-cart-shopping me-2"></i> Cart</a></li>
  ...
  <div class="container-fluid px-0">
    <ul class="nav justify-content-between align-items-center mb-0" style="width: 100%;">
      ...
      <li class="nav-item flex-fill position-relative">
        <button class="footer-btn py-2 position-relative" onclick="loadPage('notifications.php', this)" data-page="notifications.php">
          <div class="icon-wrap mb-1 position-relative">
            <i class="fa-solid fa-bell fa-2x"></i>
            <span id="notifBadgeFooter" class="badge rounded-pill position-absolute">1</span>
          </div>
          <div class="footer-label">Notifications</div>
        </button>
      </li>
      <li class="nav-item flex-fill">
        <button class="footer-btn py-2" onclick="loadPage('cart.php', this)" data-page="cart.php">
          <div class="icon-wrap mb-1"><i class="fa-solid fa-cart-shopping fa-2x"></i></div>
...
function refreshBadgeAfterRead() { updateNotifBadge(); }

function updateNotifBadgeFromChild(count) {
  const badgeSidebar = document.getElementById("notifBadgeSidebar");
  const badgeFooter = document.getElementById("notifBadgeFooter");
  [badgeSidebar, badgeFooter].forEach(badge => {
    if (badge) {
