...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        ...
        .small-swal-cart .swal2-title {
            font-size: 1.4rem !important;
            color: #6d2e3a !important;
        }

        .small-swal-cart .swal2-html-container {
            font-size: 1rem !important;
            color: #6d2e3a !important;
        }

        .small-swal-cart .swal2-icon.swal2-success {
            border-color: #6d2e3a !important;
            color: #6d2e3a !important;
        }

        .small-swal-cart .swal2-success-ring {
            border-color: rgba(109, 46, 58, 0.4) !important;
        }

        .small-swal-cart .swal2-success-line-tip,
        .small-swal-cart .swal2-success-line-long {
...
<body>
        ...
        <div class="cart-main-row">
                        ...
                        <div class="single-cart-item" data-id="<?= $row['cart_items_id']; ?>" data-price="<?= $row['price']; ?>">
                            ...
                            <div class="cart-item-details flex-grow-1 ps-3 ps-md-4">
                                ...
                                <div class="item-actions">
                                    ...
                                    <button class="btn-item-delete"><i class="bi bi-trash-fill"></i><span class="delete-name">Remove</span></button>
                                </div>
                            </div>
                        </div>
                        <?php endwhile; ?>
            ...
            <div class="cart-summary-col">
                <div class="cart-summary-card">
                    <div class="summary-title mb-2">Reservation Summary</div>
                    ...
                    <div class="summary-actions">
                        ...
                        <button class="btn" id="deleteBtn" disabled>REMOVE ALL</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function hideLoading() { setTimeout(() => { loadingModal.style.display = "none"; }, 100); }
            ...
            function sendCartCountToParent() {
                const count = document.querySelectorAll('.single-cart-item').length;
            ...
            document.querySelectorAll('.single-cart-item .qty-btn').forEach(btn => {
                btn.addEventListener('click', function(e) {
                    ...
                    // ✅ kapag qty naging 0, auto-delete
                    if (qty === 0) {
                        ...
                        .then(() => {
                            ...
                            if (document.querySelectorAll('.single-cart-item').length === 0) {
                                document.querySelector('.cart-items-card').innerHTML =
                                    '<div class="text-center text-muted py-4"><i>No items in your cart yet.</i></div>';
                            }
                            // ✅ update cart badge
                        ...
                        return; // importante: huwag na mag-update_cart_items kapag 0
                    }

                    // normal update kapag > 0
                    updateSummary();
            ...
            btnDelete.addEventListener('click',function(){
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "Do you really want to remove the selected item(s)?",
                    width: '350px',
                    icon: 'question',
                    showCancelButton: true,
                    ...
                    if(result.isConfirmed){
                        ...
                        .then(() => {
                            ...
                            Swal.fire({
                                icon: 'success',
                                title: 'Removed!',
                                text: 'Selected items were removed.',
                                confirmButtonColor: '#6d2e3a',
                                customClass: {
                                    popup: 'small-swal-cart'
                                }
                        ...
                        .then(data => {
                            ...
                            if(data.success) {
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Reserved!',
                                    text: 'Item(s) reserved successfully.',
                                    confirmButtonColor: '#6d2e3a',
                                    customClass: {
                                        popup: 'small-swal-cart'
                                    }
            ...
            // Send initial cart_items count to parent (dashboard)
            sendCartCountToParent();
        });
