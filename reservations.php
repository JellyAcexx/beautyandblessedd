...
.reservation-dates-row {
    display: flex;
    align-items: center;
    justify-content: space-between; /* para laging sagad sa right yung 2nd date */
    gap: 12px;
    margin-bottom: 6px;
}
...
/* Mobile: stack second date sa ilalim ng first date */
@media (max-width: 767px) {
    .reservation-dates-row {
        flex-direction: column;
        align-items: flex-start; /* pareho left aligned */
        gap: 4px;
    }

    .pickup-date-block {
        align-self: flex-start; /* siguradong nasa ilalim at left pa rin */
    }
}
...
/* Huwag generic .modal, gawing ID-based */
#reservationModal {
    display: none;
    position: fixed;
    top: 0; left: 0;
    width: 100%;
    height: 100%;
    background-color: rgba(0,0,0,0.4); /* dim para sa reservations lang */
    overflow-y: auto;
    z-index: 1000;
}
...
/* Icon color */
.swal2-small .swal2-icon.swal2-success,
.swal2-small .swal2-icon.swal2-error,
.swal2-small .swal2-icon.swal2-question,
.swal2-small .swal2-icon.swal2-warning,
.swal2-small .swal2-icon.swal2-info {
    border-color: #6d2e3a !important;
    color: #6d2e3a !important;
}

.swal2-small .swal2-success-ring,
.swal2-small .swal2-error-ring,
.swal2-small .swal2-question-ring,
.swal2-small .swal2-warning-ring,
.swal2-small .swal2-info-ring {
    border-color: rgba(109, 46, 58, 0.4) !important;
}

.swal2-small .swal2-success-line-tip,
.swal2-small .swal2-success-line-long,
.swal2-small .swal2-error-line-tip,
.swal2-small .swal2-error-line-long,
.swal2-small .swal2-question-line-tip,
.swal2-small .swal2-question-line-long,
.swal2-small .swal2-warning-line-tip,
.swal2-small .swal2-warning-line-long,
.swal2-small .swal2-info-line-tip,
.swal2-small .swal2-info-line-long {
    background-color: #6d2e3a !important;
}
...
@media (max-width: 768px) {
    ...
    #modalCardsContainer table th {
        font-size: 13px !important;
    }
    #modalCardsContainer table tbody td {
...
<div id="reservationModal" class="modal" style="display:none;">
  <div class="modal-content pretty-modal">
    ...
    <div id="modalHeader" class="modal-header py-1">
      <h2 id="modalTitle" class="modal-title">Reservations</h2>
